    ...
    <main className="main">
      <header className="header">
        ...
        <div className="main-info">
          <h1 className="title">Design <span className="title-light">Agency</span></h1>
          <p className="subline">make you dreams come true</p>
          <form className="form form-header"><button className="button button-green">get stared</button></form>
        </div>  
      </header>
